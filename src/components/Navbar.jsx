...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed w-full left-0 top-0 z-[999] ${sticky ? " p-1 bg-slate-600 text-gray-900" : "text-white"
        }`}
    >
      <div className="flex items-center justify-between">
        <div className="mx-7">
          <h4 className="text-4xl font-bold uppercase">
            <span className="text-purple-600">Mujahid</span>
          </h4>
        </div>
        <div
          className={` ${sticky ? "md:bg-white/0 bg-white" : "bg-yellow"
